...
def process_dir(dir_path):
    ...
    for img_path in img_paths:
        pid, sceneid, camid, frameid = map(int, pattern.search(img_path).groups())
...
dataset_dir = '/home/rdelussu/MMT/examples/data/clonedperson/ClonedPerson/'
...
#img_per_camid_per_sceneid_per_pid_v = ClonedPerson2.process_dir(ClonedPerson2.train_dir)
